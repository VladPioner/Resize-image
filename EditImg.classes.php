    ...
    */
    ...
    function inscribed($width, $height, $img_input, $dir_save = null, $new_file_name = false, $arr_bg = false, $new_ext = false,$crop_position = self::CROP_CENTER){
        ...
        if($h_new == $height){
            ...
            //imagecopyresized($finish_img, $min_img, $shift, 0, 0, 0, $width-2*$shift, $height, $w_new, $h_new);
        }else{
            ...
            //imagecopyresized($finish_img, $min_img, 0, $shift, 0, 0, $width, $height-2*$shift, $w_new, $h_new);
        }
